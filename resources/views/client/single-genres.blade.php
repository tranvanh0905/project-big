    ...
    <div class="master-container-fluid">
        ...
        <div class="pr-0 pr-e-md-15">
                        ...
                        <div class="owl-carousel owl-theme-adonis">
                            <div class="item">
                                ...
                                @foreach($latestSong as $song)
                                    <?php $count++?>
                                    <div class="music-img-box @if($count % 2 != 0) mb-e-30 mb-e-md-40 @endif">
                                        <div class="img-box box-rounded-sm img-box-md">
                                            <img class="retina" src="{{$song->image}}"
                                                 data-2x="{{$song->image}}" alt="{{$song->name}}">
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-15 pb-e-15 play-song" data-song-id="{{$song->id}}">
            ...
            <section>
                <div class="d-flex flex-row">
                    <div class="title-box">
                        <h4 class="title">New Albums</h4>
                    </div>
                    <div class="button-right ml-auto ml-auto d-flex align-items-end">
                        <a href="#" class="inactive-color mr-md-0 mb-4">See all <span
                        ...
                        <div class="owl-carousel owl-theme-adonis">
                            ...
                            <div class="item">
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             src="client/images/new-releases/new-releases-19.jpg"
                            ...
                            <div class="item">
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             src="client/images/new-releases/new-releases-40.jpg"
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-4@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-9@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                            ...
                            <div class="item">
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             src="client/images/new-releases/new-releases-43.jpg"
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-7@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-8@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-1@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-2@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-5@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-6@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-10@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-11@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
                                ...
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             ...
                                             data-2x="assets/images/new-releases/new-releases-12@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
                                                                class="play-icon"></i></span>
            ...
            <section>
                <div class="d-flex flex-row">
                    <div class="title-box">
                        <h4 class="title">&dollar;5.00 Albums</h4>
                    </div>
                    <div class="button-right ml-auto ml-auto d-flex align-items-end">
                        <a href="#" class="inactive-color mr-md-0 mb-4">See all <span
                                class="adonis-icon pl-1 icon-arrow icon-1x"><svg
                        ...
                        <div class="owl-carousel owl-theme-adonis">
                            <div class="item">
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             src="client/images/new-releases/new-releases-29.jpg"
                            ...
                            <div class="item">
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             src="client/images/new-releases/new-releases-30.jpg"
                            ...
                            <div class="item">
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             src="client/images/new-releases/new-releases-34.jpg"
                            ...
                            <div class="item">
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             src="client/images/new-releases/new-releases-36.jpg"
                            ...
                            <div class="item">
                                <div class="music-img-box">
                                    <div class="img-box box-rounded-sm">
                                        <img class="retina"
                                             src="client/images/new-releases/new-releases-37.jpg"
                                             data-2x="assets/images/new-releases/new-releases-9@2x.jpg" alt="">
                                        <div class="hover-state">
                                            <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                        <span class="pointer play-btn-dark round-btn"><i
