    ...
    <div class="master-container-fluid">
        ...
        <div class="row justify-content-between">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 pt-3 pt-md-0">
                        ...
                        <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos
                            himenaeos. Suspendisse faucibus sed dolor eget posuere.Sed id interdum urna. Nam ac
                            elit a ante commodo tristique. Duis lacus urna, condimentum a vehicula a, hendrerit
                            ac nisi Lorem ipsum dolor sit amet
            ...
            <div class="col-xl-5 text-center text-md-right mt-auto">
                <button class="btn btn-outline active-border rounded-btn btn-lg-wide mr-2 mr-md-4">FOLLOW
                </button>
                <button class="btn btn-45-45 btn-primary p-0 rounded-circle text-center dropdown-menu-toggle">
                            <span class="pointer text-light"><span class="adonis-icon icon-4x"><svg
                                        xmlns="http://www.w3.org/2000/svg" version="1.1"><use
                                            xlink:href="#icon-horizontal-dots"></use></svg></span></span></button>
            </div>
        </div>
        ...
        <section>
            <div class="title-box">
                <h2 class="title h3-md">Ralated Playlists</h2>
            </div>
            <div class="adonis-carousel auto-fit-columns" data-auto-width="yes" data-item-parent=".owl-carousel"
                 data-auto-fit-items=".item" data-dots="yes" data-item-width="260" data-item-max-width="280">
                <div class="gutter-30">
        ...
        <section>
            ...
            <div class="adonis-carousel auto-fit-columns" data-auto-width="yes" data-item-parent=".owl-carousel"
                 data-auto-fit-items=".item" data-dots="yes" data-item-width="366" data-item-max-width="380">
                <div class="gutter-30">
                    <div class="owl-carousel owl-theme-adonis">
                        <div class="item">
                            <div class="music-img-box">
