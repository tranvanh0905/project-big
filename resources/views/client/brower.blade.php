            ...
            <section>
                <div class="d-flex flex-row">
                    ...
                    <div class="button-right ml-auto ml-auto d-flex align-items-end">
                        <a href="" class="inactive-color mr-md-0 mb-4">Xem tất cả<span
                        ...
                        <div class="owl-carousel owl-theme-adonis">
                            <div class="item">
                                ...
                                @foreach($allAlbum as $album)
                                    <?php $count_loop++ ?>
                                    <div class="music-img-box  @if($count_loop % 2 != 0) mb-e-30 mb-e-md-40 @endif">
                                        ...
                                        <p class="sub-title category"><a href="#">{{$album->artist->nickname}}</a></p>
                                    </div>
                                    @if($count_loop % 2 == 0)
                                        {!!$html!!}
                                    @endif
                            ...
                            @foreach($allPlaylist as $playlist)
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        ...
                                        <p class="sub-title category">{{count($playlist->playlistDetail)}} bài hát</p>
                                    </div>
                                </div>
