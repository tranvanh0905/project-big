            ...
            <div class="master-container-fluid">
                <div class="row adonis-player pt-3 flex-nowrap justify-content-between">
                    <div class="col-sm-5 col-lg-4 col-xxl-3 d-none d-sm-block">
                        <div class="media current-item">
                            ...
                            <div class="ml-auto mt-auto mb-auto align-items-center d-none d-xl-flex lh-0">
                                ...
                                <a href="#"
                                   class="pl-2 ml-3 pr-2 d-inline-block inactive-color current-track-menu"><span
                                        class="adonis-icon icon-2x"><svg version="1.1"
                                                                         xmlns="http://www.w3.org/2000/svg"
                                                                         viewBox="0 0 6 32"><path
                    ...
                    <div
                        ...
                        <div class="mr-e-30"><a class="toggle-off-canvas" data-target="#adonis-playlist"
