<div class="ms_footer_wrapper">
    <div class="ms_footer_logo">
        <a href="index.html"><img src="client/images/open_logo.png" alt=""></a>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer_box footer_app">
                    ...
                    <p>Go Mobile with our app.<br> Listen to your favourite songs at just one click. Download Now !
                    </p>
                    <a href="#" class="foo_app_btn"><img src="client/images/google_play.jpg" alt=""
                                                         class="img-fluid"></a>
                    <a href="#" class="foo_app_btn"><img src="client/images/app_store.jpg" alt="" class="img-fluid"></a>
                    <a href="#" class="foo_app_btn"><img src="client/images/windows.jpg" alt="" class="img-fluid"></a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="foo_con_info">
                        <li>
                            <div class="foo_con_icon">
                                <img src="client/images/svg/phone.svg" alt="">
                            </div>
                        ...
                        <li>
                            <div class="foo_con_icon">
                                <img src="client/images/svg/message.svg" alt="">
                            </div>
                            <div class="foo_con_data">
                        ...
                        <li>
                            <div class="foo_con_icon">
                                <img src="client/images/svg/add.svg" alt="">
                            </div>
                            <div class="foo_con_data">
